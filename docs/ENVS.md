...
| NEXT_PUBLIC_HOMEPAGE_HIDDEN_OP_NODE_TXS | `boolean` | Set to true if op-node transactions will not appear | - | `true` | `false` | v1.32.x+ |
...
| Variable | Type| Description | Compulsoriness  | Default value | Example value | Version |
| --- | --- | --- | --- | --- | --- | --- |
| NEXT_PUBLIC_TOKENS_UPDATED_ADDRESS | `string` | Set the address if the token has changed | - | `` | `0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000` | v1.32.x+ |
| NEXT_PUBLIC_TOKENS_UPDATED_NAME | `string` | Set the token name if the token has changed | - | `Oasys` | `` | v1.32.x+ |
| NEXT_PUBLIC_TOKENS_UPDATED_SYMBOL | `string` | Set the token symbol if the token has changed | - | `OAS` | `` | v1.32.x+ |
...
| NEXT_PUBLIC_RE_CAPTCHA_V3_APP_SITE_KEY | `string` | See [below](ENVS.md#google-recaptcha) | Required | - | `<your-secret>` | v1.36.0+ |
...
| Variable | Type| Description | Compulsoriness  | Default value | Example value | Version |
| --- | --- | --- | --- | --- | --- | --- |
| NEXT_PUBLIC_RE_CAPTCHA_V3_APP_SITE_KEY | `string` | reCAPTCHA v3 site key. The site key must be generated for a specific domain and will be invalid if used on non-matching domains. See [reCAPTCHA v3 documentation](https://developers.google.com/recaptcha/docs/v3) for details. Note: Updated from NEXT_PUBLIC_RE_CAPTCHA_APP_SITE_KEY in v1.36.0+ | Required | - | `<your-site-key>` | v1.36.0+ |
